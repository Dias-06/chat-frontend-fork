const MenuNavigation = () => {
  return (
    <section className="border-t border-t-[#000000B2] py-2 w-96">
            <ul className="flex items-center justify-center gap-3 list-none">
                <li className="flex flex-col justify-center items-center h-10 w-20">
                    <span className="text-gray">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 2H4C2.9 2 2 2.9 2 4V22L6 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2ZM20 16H6L4 18V4H20V16Z" fill="currentColor"/>
                        </svg> 
                    </span>
                    <p className="text-[14px] font-normal text-gray leading[120%]">Чаты</p>
                </li>
                <li className="flex flex-col justify-center items-center h-10 w-20">
                    <span className="text-gray">
                    ...
                    <p className="text-[14px] font-normal text-gray leading[120%]">Контакты</p>
                </li>
                <li className="flex flex-col justify-center items-center h-10 w-20">
                    <span className="text-gray">
                        <svg width="20" height="20" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.27539 16L2.77539 11.7603M2.77539 11.7603L6.33906 1.68776C6.6635 0.770747 7.88728 0.770748 8.21172 1.68776L11.7754 11.7603M2.77539 11.7603H11.7754M11.7754 11.7603L13.2754 16" stroke="currentColor" stroke-width="2" stroke-linecap="square"/>
                        </svg>
                    </span>
                    <p className="text-[14px] font-normal text-gray leading[120%]">Сервисы</p>
                </li>
                <li className="flex flex-col justify-center items-center h-10 w-20">
                    <span className="text-gray">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="text-[14px] font-normal text-gray leading[120%]">Настройки</p>
                </li>
            </ul>
    </section>
  )
