...
const ProfileInfo = (props: Props) => {
  ...
  return (
    <div className='border border-primary p-3 rounded-lg flex  items-center gap-3'>
        <UserAvatar showStatus = {false} size={20} avatar={{avatar_url: "https://cdn-icons-png.flaticon.com/128/1077/1077063.png"}}/>
        <div className='space-y-1'>
            <h1 className='font-medium text-[16px] leading-[120%] text-black'>{fullName}</h1>
